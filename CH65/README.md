...
Instead of flowing water downhill from each cell, try reversing the problem: start from the ocean borders and flow uphill using BFS or DFS. Find cells reachable from both oceans.
